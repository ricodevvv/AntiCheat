...
public final class NMSValueParser {
	...
	public static void parse(KatanaPlayer data) {
	...
	public static double moveFlying(KatanaPlayer data, float strafe, float forward, boolean sprint) {
	...
	public static Pair<Float, Float> moveFlyingPair(KatanaPlayer data, float strafe, float forward, boolean sprint) {
		float friction = moveEntityWithHeading(data, sprint).getY();
		float f = strafe * strafe + forward * forward;
		if (f >= 1.0E-4F) {
			f = MathHelper.sqrt_float(f);
	...
	public static Pair<Float, Float> moveFlyingPair2(KatanaPlayer data, float strafe, float forward, float friction) {
		float f = strafe * strafe + forward * forward;
		if (f >= 1.0E-4F) {
			f = MathHelper.sqrt_float(f);
			if (f < 1.0F) {
	...
	public static Pair<Float, Float> moveEntityWithHeading(KatanaPlayer data) {
		if (!data.isOnWater()) {
			float f4 = 0.91F;
	...
	public static Pair<Float, Float> moveEntityWithHeading(KatanaPlayer data, boolean sprint) {
	...
	public static double loopKeys(KatanaPlayer data) {
	...
	public static Pair<Double, Double> loopKeysGetKeys(KatanaPlayer data, double kbX, double kbZ) {
	...
	public static Pair<Double, Double> bruteforceAttack(KatanaPlayer data, double kbX, double kbZ) {
