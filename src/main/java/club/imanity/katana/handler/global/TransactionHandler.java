...
public class TransactionHandler {
	public void handlePlayReceive(PacketPlayReceiveEvent e, long nanoTime, KatanaPlayer data) {
	...
	public void handlePacketPlaySend(PacketPlaySendEvent e, long nanoTime, KatanaPlayer data) {
		...
		// 004: astore 5
		// 006: aload 4
		// 008: invokevirtual me/liwk/katana/data/KatanaPlayer.isObjectLoaded ()Z
		// 00b: ifeq 6ed
		// 00e: getstatic me/liwk/katana/handler/global/TransactionHandler$1.$SwitchMap$com$github$retrooper$packetevents$protocol$packettype$PacketType$Play$Server [I
		// 011: aload 5
		...
		// 0b0: astore 7
		// 0b2: aload 4
		// 0b4: invokevirtual me/liwk/katana/data/KatanaPlayer.getLocation ()Lme/liwk/katana/util/location/CustomLocation;
		// 0b7: astore 8
		// 0b9: aload 4
		// 0bb: invokevirtual me/liwk/katana/data/KatanaPlayer.isNewerThan8 ()Z
		// 0be: ifne 145
		// 0c1: aload 6
		...
		// 0d1: dup
		// 0d2: aload 8
		// 0d4: getfield me/liwk/katana/util/location/CustomLocation.x D
		// 0d7: dconst_0
		// 0d8: dconst_0
		...
		// 0f2: dconst_0
		// 0f3: aload 8
		// 0f5: getfield me/liwk/katana/util/location/CustomLocation.y D
		// 0f8: dconst_0
		...
		// 113: dconst_0
		// 114: aload 8
		// 116: getfield me/liwk/katana/util/location/CustomLocation.z D
		...
		// 145: getstatic me/liwk/katana/Katana.SERVER_VERSION Lcom/github/retrooper/packetevents/manager/server/ServerVersion;
		...
		// 174: dstore 14
		// 176: new me/liwk/katana/util/Teleport
		// 179: dup
		// 17a: new me/liwk/katana/util/TeleportPosition
		// 17d: dup
		// 17e: dload 10
		// 180: dload 12
		// 182: dload 14
		// 184: invokespecial me/liwk/katana/util/TeleportPosition.<init> (DDD)V
		// 187: invokespecial me/liwk/katana/util/Teleport.<init> (Lme/liwk/katana/util/TeleportPosition;)V
		// 18a: astore 16
		// 18c: aload 4
		// 18e: aload 4
		// 190: aload 16
		// 192: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;Lme/liwk/katana/util/Teleport;)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$0 (Lme/liwk/katana/data/KatanaPlayer;Lme/liwk/katana/util/Teleport;Ljava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 197: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 19a: aload 4
		// 19c: aload 4
		// 19e: aload 16
		// 1a0: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;Lme/liwk/katana/util/Teleport;)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$2 (Lme/liwk/katana/data/KatanaPlayer;Lme/liwk/katana/util/Teleport;Ljava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 1a5: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPostPing (Lme/liwk/katana/util/gui/Callback;)V
		// 1a8: aload 4
		// 1aa: aload 4
		// 1ac: invokevirtual me/liwk/katana/data/KatanaPlayer.getServerTick ()J
		// 1af: invokevirtual me/liwk/katana/data/KatanaPlayer.setLastTeleportPacket (J)V
		// 1b2: goto 6ed
		...
		// 1d2: if_icmpne 6ed
		// 1d5: aload 4
		// 1d7: invokevirtual me/liwk/katana/data/KatanaPlayer.getCurrentServerTransaction ()I
		// 1da: istore 8
		// 1dc: aload 4
		// 1de: bipush 1
		// 1df: invokevirtual me/liwk/katana/data/KatanaPlayer.setConfirmingVelocity (Z)V
		// 1e2: aload 4
		// 1e4: iload 8
		// 1e6: aload 7
		// 1e8: aload 4
		// 1ea: invokedynamic call (ILcom/github/retrooper/packetevents/util/Vector3d;Lme/liwk/katana/data/KatanaPlayer;)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$3 (ILcom/github/retrooper/packetevents/util/Vector3d;Lme/liwk/katana/data/KatanaPlayer;Ljava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 1ef: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 1f2: aload 4
		// 1f4: aload 4
		// 1f6: iload 8
		// 1f8: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;I)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$4 (Lme/liwk/katana/data/KatanaPlayer;ILjava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 1fd: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPostPing (Lme/liwk/katana/util/gui/Callback;)V
		// 200: aload 4
		// 202: bipush 0
		// 203: invokevirtual me/liwk/katana/data/KatanaPlayer.setPlayerVelocityCalled (Z)V
		// 206: aload 4
		// 208: bipush 0
		// 209: invokevirtual me/liwk/katana/data/KatanaPlayer.setPlayerExplodeCalled (Z)V
		// 20c: goto 6ed
		...
		// 241: aload 4
		// 243: aload 9
		// 245: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;Lcom/github/retrooper/packetevents/util/Vector3f;)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$5 (Lme/liwk/katana/data/KatanaPlayer;Lcom/github/retrooper/packetevents/util/Vector3f;Ljava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 24a: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 24d: aload 4
		// 24f: aload 4
		// 251: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$6 (Lme/liwk/katana/data/KatanaPlayer;Ljava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 256: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPostPing (Lme/liwk/katana/util/gui/Callback;)V
		// 259: goto 6ed
		...
		// 268: aload 4
		// 26a: aload 10
		// 26c: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerEntityRotation;)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$7 (Lme/liwk/katana/data/KatanaPlayer;Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerEntityRotation;Ljava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 271: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 274: goto 6ed
		// 277: aload 5
		...
		// 2e1: dload 14
		// 2e3: dload 16
		// 2e5: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;IDDD)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$8 (Lme/liwk/katana/data/KatanaPlayer;IDDDLjava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 2ea: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 2ed: aload 4
		// 2ef: aload 4
		// 2f1: iload 11
		// 2f3: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;I)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$9 (Lme/liwk/katana/data/KatanaPlayer;ILjava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 2f8: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPostPing (Lme/liwk/katana/util/gui/Callback;)V
		// 2fb: goto 6ed
		...
		// 32e: dload 14
		// 330: dload 16
		// 332: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerSpawnLivingEntity;DDD)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$10 (Lme/liwk/katana/data/KatanaPlayer;Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerSpawnLivingEntity;DDDLjava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 337: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 33a: goto 6ed
		...
		// 36d: dload 14
		// 36f: dload 16
		// 371: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerSpawnEntity;DDD)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$11 (Lme/liwk/katana/data/KatanaPlayer;Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerSpawnEntity;DDDLjava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 376: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 379: goto 6ed
		...
		// 3ac: dload 16
		// 3ae: aload 11
		// 3b0: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;DDDLcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerSpawnPlayer;)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$12 (Lme/liwk/katana/data/KatanaPlayer;DDDLcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerSpawnPlayer;Ljava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 3b5: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 3b8: goto 6ed
		...
		// 3d7: iload 13
		// 3d9: aload 12
		// 3db: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;ILcom/github/retrooper/packetevents/util/Vector3d;)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$13 (Lme/liwk/katana/data/KatanaPlayer;ILcom/github/retrooper/packetevents/util/Vector3d;Ljava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 3e0: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 3e3: aload 4
		// 3e5: aload 4
		// 3e7: iload 13
		// 3e9: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;I)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$14 (Lme/liwk/katana/data/KatanaPlayer;ILjava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 3ee: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPostPing (Lme/liwk/katana/util/gui/Callback;)V
		// 3f1: goto 6ed
		...
		// 407: aload 4
		// 409: aload 12
		// 40b: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;[I)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$15 (Lme/liwk/katana/data/KatanaPlayer;[ILjava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 410: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 413: goto 6ed
		...
		// 41e: astore 11
		// 420: aload 4
		// 422: invokevirtual me/liwk/katana/data/KatanaPlayer.getEntityId ()I
		// 425: aload 11
		...
		// 42f: aload 4
		// 431: aload 11
		// 433: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerUseBed;)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$16 (Lme/liwk/katana/data/KatanaPlayer;Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerUseBed;Ljava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 438: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 43b: goto 6ed
		...
		// 446: astore 12
		// 448: aload 4
		// 44a: invokevirtual me/liwk/katana/data/KatanaPlayer.getEntityId ()I
		// 44d: aload 12
		...
		// 460: aload 4
		// 462: aload 4
		// 464: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$17 (Lme/liwk/katana/data/KatanaPlayer;Ljava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 469: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 46c: goto 6ed
		// 46f: aload 4
		// 471: aload 4
		// 473: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$18 (Lme/liwk/katana/data/KatanaPlayer;Ljava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 478: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 47b: goto 6ed
		// 47e: aload 4
		// 480: aload 4
		// 482: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$19 (Lme/liwk/katana/data/KatanaPlayer;Ljava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 487: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 48a: goto 6ed
		...
		// 49c: istore 14
		// 49e: aload 4
		// 4a0: invokevirtual me/liwk/katana/data/KatanaPlayer.getEntityId ()I
		// 4a3: iload 14
		// 4a5: if_icmpeq 4a9
		// 4a8: return
		// 4a9: aload 13
		...
		// 4ae: aload 4
		// 4b0: invokevirtual me/liwk/katana/data/KatanaPlayer.getClientVersion ()Lcom/github/retrooper/packetevents/protocol/player/ClientVersion;
		...
		// 4c5: iload 15
		// 4c7: iload 16
		// 4c9: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;II)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$20 (Lme/liwk/katana/data/KatanaPlayer;IILjava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 4ce: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 4d1: goto 6ed
		...
		// 4dc: astore 13
		// 4de: aload 4
		// 4e0: invokevirtual me/liwk/katana/data/KatanaPlayer.getEntityId ()I
		// 4e3: aload 13
		...
		// 4ee: aload 4
		// 4f0: aload 13
		// 4f2: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerRemoveEntityEffect;)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$21 (Lme/liwk/katana/data/KatanaPlayer;Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerRemoveEntityEffect;Ljava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 4f7: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 4fa: goto 6ed
		...
		// 50c: aload 4
		// 50e: invokevirtual me/liwk/katana/data/KatanaPlayer.getEntityId ()I
		// 511: if_icmpeq 515
		// 514: return
		// 515: aload 4
		// 517: aload 13
		// 519: aload 4
		// 51b: invokedynamic call (Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerUpdateAttributes;Lme/liwk/katana/data/KatanaPlayer;)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$22 (Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerUpdateAttributes;Lme/liwk/katana/data/KatanaPlayer;Ljava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 520: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 523: goto 6ed
		...
		// 535: aload 4
		// 537: invokevirtual me/liwk/katana/data/KatanaPlayer.getEntityId ()I
		// 53a: if_icmpne 6ed
		// 53d: getstatic me/liwk/katana/Katana.SERVER_VERSION Lcom/github/retrooper/packetevents/manager/server/ServerVersion;
		...
		// 549: bipush 12
		// 54b: istore 14
		// 54d: getstatic me/liwk/katana/Katana.SERVER_VERSION Lcom/github/retrooper/packetevents/manager/server/ServerVersion;
		...
		// 55b: istore 14
		// 55d: goto 570
		// 560: getstatic me/liwk/katana/Katana.SERVER_VERSION Lcom/github/retrooper/packetevents/manager/server/ServerVersion;
		...
		// 575: iload 14
		// 577: invokestatic me/liwk/katana/handler/global/TransactionHandler.getIndex (Ljava/util/List;I)Lcom/github/retrooper/packetevents/protocol/entity/data/EntityData;
		// 57a: astore 15
		// 57c: aload 15
		// 57e: ifnull 58f
		// 581: aload 4
		// 583: aload 15
		// 585: aload 4
		// 587: invokedynamic call (Lcom/github/retrooper/packetevents/protocol/entity/data/EntityData;Lme/liwk/katana/data/KatanaPlayer;)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$23 (Lcom/github/retrooper/packetevents/protocol/entity/data/EntityData;Lme/liwk/katana/data/KatanaPlayer;Ljava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 58c: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 58f: goto 6ed
		...
		// 5ab: putfield me/liwk/katana/data/KatanaPlayer.gameMode Lcom/github/retrooper/packetevents/protocol/player/GameMode;
		// 5ae: aload 4
		// 5b0: aload 4
		// 5b2: invokevirtual me/liwk/katana/data/KatanaPlayer.getGameMode ()Lcom/github/retrooper/packetevents/protocol/player/GameMode;
		...
		// 5bc: goto 5c0
		// 5bf: bipush 0
		// 5c0: invokevirtual me/liwk/katana/data/KatanaPlayer.setSpectating (Z)V
		// 5c3: aload 4
		// 5c5: aload 13
		// 5c7: invokevirtual com/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerJoinGame.getEntityId ()I
		// 5ca: invokevirtual me/liwk/katana/data/KatanaPlayer.setEntityId (I)V
		// 5cd: goto 6ed
		...
		// 5e7: aload 4
		// 5e9: aload 13
		// 5eb: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerChangeGameState;)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$24 (Lme/liwk/katana/data/KatanaPlayer;Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerChangeGameState;Ljava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 5f0: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 5f3: goto 6ed
		...
		// 5fe: astore 13
		// 600: aload 4
		// 602: invokevirtual me/liwk/katana/data/KatanaPlayer.getAbilityManager ()Lme/liwk/katana/handler/AbilityManager;
		// 605: aload 13
		// 607: invokevirtual me/liwk/katana/handler/AbilityManager.onAbilityServer (Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerPlayerAbilities;)V
		// 60a: goto 6ed
		...
		// 619: aload 4
		// 61b: aload 13
		// 61d: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerHeldItemChange;)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$25 (Lme/liwk/katana/data/KatanaPlayer;Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerHeldItemChange;Ljava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 622: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 625: goto 6ed
		...
		// 630: astore 13
		// 632: getstatic me/liwk/katana/Katana.SERVER_VERSION Lcom/github/retrooper/packetevents/manager/server/ServerVersion;
		...
		// 64c: aload 4
		// 64e: invokevirtual me/liwk/katana/data/KatanaPlayer.getEntityId ()I
		// 651: if_icmpne 694
		// 654: aload 13
		...
		// 675: iload 14
		// 677: aload 15
		// 679: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;ZILorg/bukkit/entity/Entity;)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$26 (Lme/liwk/katana/data/KatanaPlayer;ZILorg/bukkit/entity/Entity;Ljava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 67e: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 681: aload 4
		// 683: iload 14
		// 685: bipush -1
		// 686: if_icmpeq 68d
		...
		// 68a: goto 68e
		// 68d: bipush 0
		// 68e: invokevirtual me/liwk/katana/data/KatanaPlayer.setRidingUncertain (Z)V
		// 691: goto 6ed
		// 694: aload 13
		...
		// 6ae: iload 14
		// 6b0: iload 15
		// 6b2: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerAttachEntity;IZ)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$27 (Lme/liwk/katana/data/KatanaPlayer;Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerAttachEntity;IZLjava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 6b7: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 6ba: goto 6ed
		...
		// 6c9: aload 4
		// 6cb: aload 13
		// 6cd: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerSetPassengers;)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$28 (Lme/liwk/katana/data/KatanaPlayer;Lcom/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerSetPassengers;Ljava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 6d2: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 6d5: goto 6ed
		// 6d8: aload 4
		// 6da: aload 4
		// 6dc: invokedynamic call (Lme/liwk/katana/data/KatanaPlayer;)Lme/liwk/katana/util/gui/Callback; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, me/liwk/katana/handler/global/TransactionHandler.lambda$handlePacketPlaySend$29 (Lme/liwk/katana/data/KatanaPlayer;Ljava/lang/Integer;)V, (Ljava/lang/Integer;)V ]
		// 6e1: invokevirtual me/liwk/katana/data/KatanaPlayer.queueToPrePing (Lme/liwk/katana/util/gui/Callback;)V
		// 6e4: goto 6ed
		// 6e7: aload 4
		// 6e9: lload 2
		// 6ea: invokevirtual me/liwk/katana/data/KatanaPlayer.setLastPingTime (J)V
		// 6ed: return
	}

	public void handleTransaction(short number, long nanoTime, KatanaPlayer data) {
		if (data.getScheduledTransactions().containsKey(number)) {
			++data.sentConfirms;
		}
		...
		if ((number < -20000 || number > -3000) && !wasFirst) {
			if (!data.sendingPledgePackets && data.getTotalTicks() > 300) {
				Tasker.run(() -> data.getBukkitPlayer().kickPlayer(ChatColor.translateAlternateColorCodes('&', katana.getInstance().getConfigManager().getUninjectedKick()) + " (Time out)"));
			}
		} else {
			data.sentPingRequest = true;
		...
		if (absT - absTL > 1
			&& absT - absTL < 50
			&& katana.getInstance().getConfigManager().isNethandler()
			&& (katana.getInstance().getConfigManager().isDelay() || katana.getInstance().getConfigManager().isSpoof())) {
			katana.getInstance().printCool("&b> &fTransactions have been skipped, proxy issue? " + absT + " | " + absTL);
		}
