...
public final class PredictionHandler extends AbstractPredictionHandler {
	...
	public PredictionHandler(KatanaPlayer data, club.imanity.katana.katana katana) {
		super(data, katana);
	}
	...
	public void moveEntity(double x, double y, double z) {
		...
		if (flag) {
			double d6;
			for (d6 = 0.05;
				x != 0.0 && this.katana.getNmsWorldProvider().getCollidingBoundingBoxes(this.data.getBukkitPlayer(), this.getEntityBoundingBox().offset(x, -1.0, 0.0)).isEmpty();
				d3 = x
			) {
				double var18;
				double var19;
			...
			while (z != 0.0 && this.katana.getNmsWorldProvider().getCollidingBoundingBoxes(this.data.getBukkitPlayer(), this.getEntityBoundingBox().offset(0.0, -1.0, z)).isEmpty()) {
				double var22;
				double var23;
			...
			while (x != 0.0 && z != 0.0 && this.katana.getNmsWorldProvider().getCollidingBoundingBoxes(this.data.getBukkitPlayer(), this.getEntityBoundingBox().offset(x, -1.0, z)).isEmpty()) {
				double var20;
				double var21;
