...
package club.imanity.katana.check.impl.combat.velocity;
...
import club.imanity.katana.util.pair.Pair3;
import club.imanity.katana.util.pair.VelocityData5;
...
public final class VelocityB extends PacketCheck {
	...
	public VelocityB(KatanaPlayer data, club.imanity.katana.katana katana) {
		super(data, katana);
	}
