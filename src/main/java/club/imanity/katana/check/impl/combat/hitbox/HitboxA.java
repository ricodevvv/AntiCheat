...
package club.imanity.katana.check.impl.combat.hitbox;
...
public final class HitboxA extends PacketCheck {
	public HitboxA(KatanaPlayer data, club.imanity.katana.katana katana) {
		super(data, katana);
	}

	@Override
	public void handle(Event packet) {
		if (!club.imanity.katana.katana.getInstance().getConfigManager().isDisableHitboxCheck() && !club.imanity.katana.katana.SERVER_VERSION.isNewerThanOrEquals(ServerVersion.V_1_19) && packet instanceof FlyingEvent) {
